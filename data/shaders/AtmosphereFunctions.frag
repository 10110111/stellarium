...
#define assert(x)
const int TRANSMITTANCE_TEXTURE_WIDTH = 999;
const int TRANSMITTANCE_TEXTURE_HEIGHT = 999;
const int SCATTERING_TEXTURE_R_SIZE = 999;
const int SCATTERING_TEXTURE_MU_SIZE = 999;
const int SCATTERING_TEXTURE_MU_S_SIZE = 999;
const int SCATTERING_TEXTURE_NU_SIZE = 999;
const int IRRADIANCE_TEXTURE_WIDTH = 999;
const int IRRADIANCE_TEXTURE_HEIGHT = 999;
