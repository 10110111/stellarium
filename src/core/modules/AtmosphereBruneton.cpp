...
void bindAndSetupTexture(QOpenGLFunctions_3_3_Core& gl, GLenum target, GLuint texture)
{
...
void checkFramebufferStatus(QOpenGLFunctions_3_3_Core& gl)
{
...
AtmosphereBruneton::~AtmosphereBruneton()
{
	...
	{
		auto& gl=*ctx->versionFunctions<QOpenGLFunctions_3_3_Core>();
